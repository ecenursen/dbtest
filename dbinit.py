...
INIT_STATEMENTS = [
    ...
    #Ecem
        ...
        SHIFT_HOURS INTRTVAL,
        DAYSHIFT BOOL,
        WORKING_PERSONNEL INTEGER,
        FOREIGN KEY(wORKING_PERSONNEL) REFERENCES HOSPITAL_PERSONNEL(PERSONNEL_ID)
    )""",
    ...
    """CREATE TABLE IF NOT EXISTS HOSPITAL_PERSONNEL (
        ...
        FOREIGN KEY (SHIFT_ID)  REFERENCES DAY_TABLE(GENERATED_KEY),
